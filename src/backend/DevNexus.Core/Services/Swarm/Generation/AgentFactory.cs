        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (persona.Tools.Contains("HostService"))
        {
            ...
            if (blackboard != null && !string.IsNullOrEmpty(taskId))
            {
                ...
                var swarmPlugin = new Context.SwarmHostPlugin(_hostService, blackboard, taskId);
            ...
            else
            {
                ...
                agentKernel.Plugins.AddFromObject(new HostTextPlugin(_hostService), "HostService");
