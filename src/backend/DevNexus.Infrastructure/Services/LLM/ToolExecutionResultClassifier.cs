...
/// </summary>
internal static class ToolExecutionResultClassifier
{
    /// <summary>
    /// 对工具执行输出进行分类。
    /// </summary>
    public static ToolExecutionClassificationResult Classify(string output)
    {
...
/// 工具执行结果分类结果。
/// </summary>
internal sealed record ToolExecutionClassificationResult
{
    /// <summary>
    /// 是否成功。
    /// </summary>
